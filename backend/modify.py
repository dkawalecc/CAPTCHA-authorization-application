...
def mod(DIFFICULTY=100, audio_path='testcase.wav'):
    dirname = os.path.dirname(__file__)
    modified = 'modified_res.wav'
    modified = os.path.join(dirname, modified)
    audio_path = os.path.join(dirname, audio_path)
